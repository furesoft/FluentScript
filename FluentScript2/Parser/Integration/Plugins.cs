...
namespace ComLib.Lang.Parsing
{
	...
	public class RegisteredPlugins
	{
		...
		public void Print()
		{
			var tmp = _sysStmtPlugins.Concat(_expPlugins).Concat(_tokPlugins).Concat(_lexPlugins).Concat(_postfixPlugins).Concat(_stmtPlugins).Concat(_expStmtPlugins);
