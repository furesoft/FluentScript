...
namespace ComLib.Lang.Types
{
    ...
    public class LJSDateMethods : LTypeMethods
    {
        ...
        {
            var date = target.Value; return date.ToUniversalTime().Millisecond;
        }
        ...
        {
            var date = target.Value; return date.ToString("ddd MMM dd yyyy");
        }
        ...
        {
            var date = target.Value; return date.ToLocalTime().ToString("hh mm ss");
        }

        public string ToLocaleString(LDate target)
        {
            var date = target.Value; return date.ToLocalTime().ToString("ddd MMM dd yyyy hh mm ss");
        }
